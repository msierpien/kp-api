export const API_VERSION = process.env.APP_VERSION || '1.6.16';
...
export function getApplicationVersionInfo(environment: string): ApplicationVersionInfo {
  return {
    ...
    features: [
      'ifirma-invoices-v1',
      'deployment-build-metadata-v1',
      'deployment-after-pull-wrapper-v1',
      'deployment-version-check-v1',
      ...
      'personalization-answer-row-cleanup-v1',
      'personalization-case-render-job-status-v1',
      'personalization-case-queue-summary-v1',
      ...
      'personalization-template-mm-canonical-v1',
      'personalization-template-mm-layout-v1',
      'personalization-template-simple-slots-v1',
      'orders-list-v1',
