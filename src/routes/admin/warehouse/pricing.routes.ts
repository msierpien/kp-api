    ...
    schema: {
      ...
      querystring: {
        ...
        properties: {
          ...
          costSource: { type: 'string', enum: ['ALL', 'DOCUMENT', 'WHOLESALE'] },
          status: { type: 'string', enum: ['ALL', 'READY', 'MISSING_PRICE', 'WARNING', 'ALERT', 'NO_GROUP', 'IN_GROUP', 'OVERRIDES_GROUP', 'BELOW_COST'] },
