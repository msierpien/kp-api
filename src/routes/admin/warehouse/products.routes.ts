    ...
    schema: {
      ...
      querystring: {
        ...
        properties: {
          ...
          catalogId: { type: 'string' },
          shopId: { type: 'string' },
          shopScope: { type: 'string', enum: ['mapped', 'all'] },
          ...
          wholesaleProviderIds: { type: 'array', items: { type: 'string' } },
          purchasePriceMin: { type: 'number', minimum: 0 },
          purchasePriceMax: { type: 'number', minimum: 0 },
          retailPriceMin: { type: 'number', minimum: 0 },
          retailPriceMax: { type: 'number', minimum: 0 },
          marginMin: { type: 'number' },
          marginMax: { type: 'number' },
          wholesaleOfferScope: { type: 'string', enum: ['single', 'multiple'] },
          shopMappingScope: { type: 'string', enum: ['single', 'multiple'] },
          shopPriceMismatch: { type: 'boolean' },
          hasPersonalizationTemplate: { type: 'boolean' },
    ...
    schema: {
      ...
      body: {
        ...
        properties: {
          ...
          reorderPoint: { type: ['number', 'null'], minimum: 0 },
